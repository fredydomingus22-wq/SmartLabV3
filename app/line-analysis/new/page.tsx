...
export default function NewLineAnalysisPage() {
    ...
    const handleSubmit = async () => {
        ...
        // Validate that we have values for all specs (optional, depending on requirements)
        // For now, we'll allow partial submission but warn? No, let's assume all are required.
        ...
        try {
            ...
            await createLineSampleWithAnalysis({
                ...
                collected_by: signature.name, // Using signer name as collector
